...
import type { Template } from './translation/types.js';
import type { Config } from './inboundTranslation/types.js';
...
app.post('/translate', async (req, res) => {
  try {
    ...
    const onlyParse = body.onlyParse;
    let output = '';
